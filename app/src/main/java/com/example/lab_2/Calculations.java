...
public class Calculations {
    public String[] operators = {"sin", "cos", "sqrt", "ln", "log", "tan"};
    private static final String TAG = "calculations";
    private EditText editText;
    private Context context;

    public Calculations(Context context , EditText editText)
    {
    ...
    public Queue<String> toReverseNotation(Queue<String> inf) {
        ...
        while (inf.size() >= 0) {
            if (num_pattern.matcher(next).matches())
                ...
                reverse.add(next);
            else if (next.equals("sin") || next.equals("cos") || next.equals("sqrt") || next.equals("tan") || next.equals("ln") || next.equals("log")  || next.equals("m"))
                operators.push(next);
            else if (next.equals("("))
            {
                operators.push(next);
